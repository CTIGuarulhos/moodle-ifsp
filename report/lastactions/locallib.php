...
/**
 * This file contains functions used by the lastactions reports
 *
 * @package    report
...
function report_lastactions_print_row($mod, $instance, $result) {
    global $OUTPUT, $CFG;
...
/**
 * Returns an array of the commonly used log variables by the lastactions report.
 *
 * @return array the array of variables used
 */
function report_lastactions_get_common_log_variables() {
    global $DB;
...
/**
 * Return the most commonly used user lastactions information.
 *
 ...
 */
function report_lastactions_user_lastactions($userid, $cmid, $module, $instanceid) {
    global $DB;
 ...
 * @return string
 */
function report_lastactions_user_complete($userid, $cmid, $module, $instanceid) {
    global $DB;
    ...
    if (!empty($strnumviews) && (!empty($lastlogtime))) {
        ...
        return get_string('neverseen', 'report_lastactions');
    }
}
