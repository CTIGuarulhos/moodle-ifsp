...
/**
 * This file contains functions used by the role reports
 *
 * @package    report
 * @subpackage role
...
function report_role_print_row($mod, $instance, $result) {
    global $OUTPUT, $CFG;
...
/**
 * Returns an array of the commonly used log variables by the role report.
 *
 * @return array the array of variables used
 */
function report_role_get_common_log_variables() {
    global $DB;
...
/**
 * Return the most commonly used user role information.
 *
 ...
 */
function report_role_user_role($userid, $cmid, $module, $instanceid) {
    global $DB;
 ...
 * @return string
 */
function report_role_user_complete($userid, $cmid, $module, $instanceid) {
    global $DB;
    ...
    if (!empty($strnumviews) && (!empty($lastlogtime))) {
        ...
        return get_string('neverseen', 'report_role');
    }
}
