...
/**
 * This file contains functions used by the students reports
 *
 * @package    report
 * @subpackage students
...
function report_students_print_row($mod, $instance, $result) {
    global $OUTPUT, $CFG;
...
/**
 * Returns an array of the commonly used log variables by the students report.
 *
 * @return array the array of variables used
 */
function report_students_get_common_log_variables() {
    global $DB;
...
/**
 * Return the most commonly used user students information.
 *
 ...
 */
function report_students_user_students($userid, $cmid, $module, $instanceid) {
    global $DB;
 ...
 * @return string
 */
function report_students_user_complete($userid, $cmid, $module, $instanceid) {
    global $DB;
    ...
    if (!empty($strnumviews) && (!empty($lastlogtime))) {
        ...
        return get_string('neverseen', 'report_students');
    }
}
