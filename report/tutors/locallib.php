...
/**
 * This file contains functions used by the tutors reports
 *
 * @package    report
 * @subpackage tutors
...
function report_tutors_print_row($mod, $instance, $result) {
    global $OUTPUT, $CFG;
...
/**
 * Returns an array of the commonly used log variables by the tutors report.
 *
 * @return array the array of variables used
 */
function report_tutors_get_common_log_variables() {
    global $DB;
...
/**
 * Return the most commonly used user tutors information.
 *
 ...
 */
function report_tutors_user_tutors($userid, $cmid, $module, $instanceid) {
    global $DB;
 ...
 * @return string
 */
function report_tutors_user_complete($userid, $cmid, $module, $instanceid) {
    global $DB;
    ...
    if (!empty($strnumviews) && (!empty($lastlogtime))) {
        ...
        return get_string('neverseen', 'report_tutors');
    }
}
